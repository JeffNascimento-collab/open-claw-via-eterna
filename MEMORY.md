...
## Via Eterna
- Política de trocas: compras do site ou lojas físicas podem ser trocadas em até 30 dias corridos após a compra (loja física) ou entrega (loja virtual), com joia em perfeito estado, sem sinais de uso, com Certificado de Garantia; compras do site também devem ir na embalagem original.
- Troca é por peça de valor equivalente ou usando o valor como parte do pagamento de uma peça mais cara.
- Não trocam peças com mau uso/danos, sob encomenda, ajustadas ou gravadas, salvo defeito de fabricação.
...
## Via Eterna — fluxo de atendimento (interesse em produto)
- Quando o cliente demonstrar interesse em um produto, **sempre confirmar**: "Você quer comprar **online (pelo site)** ou prefere comprar em uma **loja física**?" (muitos confundem o contato online com telefone de loja).
- Se **online**: enviar link de categoria/produto e orientar a conferir modelos/medidas/variantes no site.
- Se **loja física**: perguntar qual loja (cidade/bairro/nome). Se não souber, oferecer a lista de lojas.
- Após confirmar a loja física: encaminhar o **WhatsApp da loja** e orientar que as vendedoras confirmem o **estoque** do produto.
...
## Fonte completa (arquivos no workspace)
- viaeterna-conhecimento-agente-UNIFICADO.md
- viaeterna-base-de-conhecimento-agente.md
